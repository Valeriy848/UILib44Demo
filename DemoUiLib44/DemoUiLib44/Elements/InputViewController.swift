...
internal final class InputViewController: UIViewController, FocusObserverDelegate, InputActionDelegate {
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            releaseFocusButton.topAnchor.constraint(
                equalTo: requestFocusButton.bottomAnchor,
                constant: Metrics.topOffset),
            releaseFocusButton.leadingAnchor.constraint(
                equalTo: view.leadingAnchor,
                constant: Metrics.sideOffset),
            releaseFocusButton.trailingAnchor.constraint(
